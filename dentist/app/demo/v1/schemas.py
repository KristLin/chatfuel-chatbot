...
validators = {
    ('dentists', 'POST'): {'json': {'type': 'object', 'properties': {'dentist_name': {'type': 'string', 'description': 'Jack/Janis'}, 'location': {'type': 'string', 'description': 'Sydney/Melbourne'}, 'specialization': {'type': 'string', 'description': 'Dentistry/Orthodontics/Oral Surgery'}}}},
}

filters = {
    ('dentists', 'GET'): {200: {'headers': None, 'schema': None}, 400: {'headers': None, 'schema': None}},
    ('dentists', 'POST'): {200: {'headers': None, 'schema': None}, 400: {'headers': None, 'schema': None}},
    ('dentists_dentist_name', 'GET'): {200: {'headers': None, 'schema': None}, 400: {'headers': None, 'schema': None}},
}
